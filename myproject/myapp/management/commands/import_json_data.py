...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with open('COI.json', 'r') as file:
            data = json.load(file)['ConstitutionOfIndia']['Parts']
        ...
        for part in part_names:
            for article in articles[part]:
                ...
                Laws.objects.create(title=data[part]['Articles'][article]['Title'], text=data[part]['Articles'][article]['Text'])
