...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        input_file = "C:\\Users\\arjun\\OneDrive\\Documents\\GitHub\\Hack-Babies\\myproject\\nia_4.json"
        output_file = "C:\\Users\\arjun\\OneDrive\\Documents\\GitHub\\Hack-Babies\\myproject\\nia_5.json"

        # Function to replace 'section' with 'name'
        def replace_key(data):
            if isinstance(data, dict):
                return {
                    ('description' if k == 'section_desc' else k): replace_key(v)
