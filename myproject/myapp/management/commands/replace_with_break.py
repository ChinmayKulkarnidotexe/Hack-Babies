...
class Command(BaseCommand):
    help = "Replace newline characters with break character in a JSON file"
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"All newline characters replaced and saved to {output_file}"))
