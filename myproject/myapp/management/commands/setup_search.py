# yourapp/management/commands/setup_search.py
...
class Command(BaseCommand):
    help = 'Initializes the search index and semantic embeddings for articles'
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS("Search initialization completed"))
